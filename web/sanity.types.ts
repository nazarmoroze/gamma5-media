...
export type Case = {
  ...
  videoAspect?: "16:9" | "2:1" | "2.39:1" | "1:1" | "4:5" | "9:16";
  gallery?: Array<{
    asset?: SanityImageAssetReference;
    media?: unknown;
    hotspot?: SanityImageHotspot;
...
export type HOME_QUERY_RESULT = {
  ...
  portfolio: {
    ...
    cases: Array<{
      ...
      videoAspect: "1:1" | "16:9" | "2:1" | "2.39:1" | "4:5" | "9:16" | null;
      cover: {
        alt: string | null;
        hotspot: SanityImageHotspot | null;
        crop: SanityImageCrop | null;
...
// Source: ../web/src/sanity/queries.ts
// Variable: CASE_QUERY
// Query: *[_type == "case" && slug.current == $slug][0] {      _id,  title,  "slug": slug.current,  client,  category,  year,  orientation,  videoAspect,  cover {   alt,  hotspot,  crop,  asset->{ _id, url, metadata { lqip, dimensions { width, height } } } },  "fullVideo": fullVideoFile.asset->url,  youtubeUrl,  "previewVideo": previewVideoFile.asset->url,    _createdAt,    releaseDate,    shareImage { alt, hotspot, crop, asset->{ _id } },    scope,    summary,    gallery[] { _key, caption,   alt,  hotspot,  crop,  asset->{ _id, url, metadata { lqip, dimensions { width, height } } } },    brief,    idea,    result,    credits[] { _key, role, name },    testimonial { quote, author, role }  }
